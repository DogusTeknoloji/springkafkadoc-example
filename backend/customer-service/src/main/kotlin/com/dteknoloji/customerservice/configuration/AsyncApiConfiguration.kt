package com.dteknoloji.customerservice.configuration
...
class AsyncApiConfiguration {
    ...
    private companion object {
        const val SERVICE_TITLE = "Customer"
        const val SERVICE_VERSION = "1.0.0"
        const val SERVICE_DESC = "Nice, short desc"
        const val BOOTSTRAP_SERVERS = "ip-of-service:port"
        const val CONSUMER_BASE_PACKAGE = "com.dteknoloji.customerservice.consumer"
        const val PRODUCER_BASE_PACKAGE = "com.dteknoloji.customerservice.producer"
    }
}
