package com.dteknoloji.paymentservice.configuration.springkafkadoc
...
class AsyncApiConfiguration {
    ...
    fun asyncApiDocket(): AsyncApiDocket {
        ...
        return AsyncApiDocket.builder()
            .consumerBasePackage(CONSUMER_BASE_PACKAGE)
    ...
    private companion object {
        const val SERVICE_TITLE = "Payment"
        const val SERVICE_VERSION = "1.0.0"
        const val SERVICE_DESC = "Nice, short desc"
        const val BOOTSTRAP_SERVERS = "ip-of-service:port"
        const val CONSUMER_BASE_PACKAGE = "com.dteknoloji.paymentservice.consumer"
        const val PRODUCER_BASE_PACKAGE = "com.dteknoloji.paymentservice.producer"
    }
}
